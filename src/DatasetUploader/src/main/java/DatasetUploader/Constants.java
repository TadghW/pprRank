...
public class Constants {
    ...
    final static double[] preferredFrequencies = {20,21.2,22.4,23.6,25,26.5,28,30,31.5,33.5,35.5,37.5,40,42.5,45,47.5,50,53,56,60,63,67,71,75,80,85,90,95,100,106,112,118,125,132,140,150,
    ...
    final static double[] preferredFrequenciesLinearProgression = {2.995732274,3.054001182,3.109060959,3.161246712,3.218875825,3.277144733,3.33220451,3.401197382,3.449987546,3.511545439,
    ...
    final static double[] harmanAeOe2018 = {4.7,4.84,4.88,4.87,4.86,4.85,4.83,4.8,4.76,4.72,4.66,4.61,4.54,4.47,4.38,4.28,4.16,4.03,3.89,3.74,3.58,3.41,3.23,3.04,
    ...
    public static double calculatePpr(Double[] magnitudes){

        //-----------------------CALCULATE PPR FROM MAGNITUDE SET | CONTEXT-----------------
        ...
        for(int i = 16; i < 109; i++){
            regression.addData(Constants.preferredFrequenciesLinearProgression[i], errorCurve[i-16]);
        }
        ...
        double pprConst1 = 114.490443008238;
        double pprConst2 = 12.6217151040598;
        double pprConst3 = 15.5163857197367;
        
        Double ppr = pprConst1 - (pprConst2 * headphoneStdev) - (pprConst3 * absSlope);
